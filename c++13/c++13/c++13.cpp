...
int main()
{
	...
	CInherit ot(2000, 1, 1);
	int a;
	int add = 1;
	ot.displayDate();
	while (!((ot.getYear() == 2019) && (ot.getMonth() == 4) && (ot.getDay()) == 11))
	{
		ot.addOneDay();
		add++;
	}
